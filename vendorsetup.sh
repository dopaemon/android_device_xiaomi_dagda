...
if [ -d "vendor/xiaomi/dagda" ]; then
    echo "vendor/xiaomi/dagda: done"
else
    git clone -b lineage-21 --single-branch https://git.mainlining.org/cupid-development/proprietary_vendor_xiaomi_dagda.git vendor/xiaomi/dagda
fi
